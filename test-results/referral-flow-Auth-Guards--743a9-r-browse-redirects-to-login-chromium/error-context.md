...
- Name: referral-flow.spec.ts >> Auth Guards & Middleware >> Unauthenticated access to seeker browse redirects to login
- Location: tests\referral-flow.spec.ts:31:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/seeker/browse", waiting until "load"
