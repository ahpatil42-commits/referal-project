...
- Name: referral-flow.spec.ts >> Auth Guards & Middleware >> Unauthenticated access to referrer dashboard redirects to login
- Location: tests\referral-flow.spec.ts:21:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/referrer", waiting until "load"
