...
- Name: referral-flow.spec.ts >> Auth Guards & Middleware >> Unauthenticated access to seeker dashboard redirects to login
- Location: tests\referral-flow.spec.ts:16:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/seeker", waiting until "load"
