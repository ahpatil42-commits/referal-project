...
- Name: referral-flow.spec.ts >> Auth Guards & Middleware >> Terms page is publicly accessible
- Location: tests\referral-flow.spec.ts:65:7
...
Call log:
  - navigating to "http://localhost:3000/terms", waiting until "load"
