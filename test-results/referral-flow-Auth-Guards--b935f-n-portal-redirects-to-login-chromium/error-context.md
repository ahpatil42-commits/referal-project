...
- Name: referral-flow.spec.ts >> Auth Guards & Middleware >> Unauthenticated access to admin portal redirects to login
- Location: tests\referral-flow.spec.ts:26:7
...
Call log:
  - navigating to "http://localhost:3000/portal-admin", waiting until "load"
